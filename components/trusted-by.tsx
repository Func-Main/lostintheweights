...
export function TrustedBy() {
  const { takeoverGlitchElapsed, handleInteraction } = useStory()
  ...
  const headingGlitchActive = isTakeoverGlitchInWindow(0.52, 0.72) || isTakeoverGlitchInWindow(2.72, 2.94)
  const gridGlitchActive = isTakeoverGlitchInWindow(1.62, 1.86) || isTakeoverGlitchInWindow(3.82, 4.08)

  return (
    <section className={cn("px-4 sm:px-6 lg:px-8 py-12 sm:py-16", gridGlitchActive && "takeover-glitch-soft")}>
      <div className="mx-auto max-w-7xl">
        {/* Header */}
        <div className={cn("flex flex-col gap-4 mb-8 sm:mb-12", headingGlitchActive && "takeover-glitch-hit")}>
        ...
        <div className={cn("bg-secondary/30 rounded-2xl p-6 sm:p-8 lg:p-10", gridGlitchActive && "takeover-glitch-hit")}>
